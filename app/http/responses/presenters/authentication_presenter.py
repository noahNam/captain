...
from core.domains.authentication.schema.authentication_schema import JwtResponseSchema, LogoutResponseSchema
...
class UpdateJwtPresenter:
    def transform(self, output: Union[UseCaseSuccessOutput, UseCaseFailureOutput]):
        if isinstance(output, UseCaseSuccessOutput):
            ...
            try:
                schema = JwtResponseSchema(access_token=value_to_json.get("access_token"))
